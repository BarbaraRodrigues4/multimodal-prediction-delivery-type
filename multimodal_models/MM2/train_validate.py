...
BATCH_SIZE = 16
WEIGHT_DECAY = 0.001
LEARNING_RATE = 0.000955541506573523
PATIENCE = patience
...
best_test_results = utils.evaluate(best_model, test_loader, DEVICE)
...
final_test_results = utils.evaluate(final_model, test_loader, DEVICE, criterion)
utils.save_test_metrics(
